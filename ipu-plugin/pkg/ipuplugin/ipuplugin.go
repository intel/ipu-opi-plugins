...
func (s *server) Stop() {
	...
	log.Infof("DeleteRHPrimaryNetworkVportP4Rules, path->%s, 1->%v", s.p4rtbin, AccApfMacList[PHY_PORT1_INTF_INDEX])
	p4rtclient.DeleteRHPrimaryNetworkVportP4Rules(s.p4rtbin, AccApfMacList[PHY_PORT1_INTF_INDEX])
